...
<?php
	...
	$sql="SELECT CF, Nome, Cognome, Num_Telefono, Email FROM Utenti WHERE ID=".$_SESSION["id_Utente"]; 
	...
	// CALCOLO DEL PRIMO DEI PARAMETRI RAFFIGURANTI LA RELAZIONE DELL'UTENTE NEI CONFRONTI DEL CENTRO SPORTIVO, OVVERO IL NUMERO DI PRENOTAZIONI EFFETTUATE;
	$sql="SELECT COUNT(*) AS Num_Prenotazioni FROM Prenotazioni WHERE ID_Cliente=".$_SESSION["id_Utente"];
	$result=mysqli_query($conn, $sql);
							...
							<div class="campo">
								<div class="contenuto" style="flex-direction: column;" >
									...
									<div class="item" style="flex-direction:row; border:none;">
										...
										<p class="dettagli_campo">
											<input type="text" name="cognome" value="<?php echo $cognome; ?>" disabled="disabled" />
										</p>	
									</div>
									<div class="item" style="flex-direction:row; border:none;">
										<p class="nome_campo">
							...
							<div class="campo">
								<div class="contenuto" style="flex-direction: column;" >
									...
									<div class="item" style="flex-direction:row; border:none;">
										...
										<p class="dettagli_campo">
											<input type="password" name="password" value="........." disabled="disabled" />
										</p>	
									</div>
								</div>
							</div>
							...
							<div class="campo">
								<div class="contenuto" style="flex-direction: column;" >
									<div class="item" style="flex-direction:row; border:none;">
										...
										<p class="dettagli_campo">
											<input type="text" name="num_prenotazioni" value="<?php echo $num_prenotazioni; ?>" disabled="disabled" />
										</p>	
									</div>
									<div class="item" style="flex-direction:row; border:none;">
										<p class="nome_campo">
