...
<body>
	<?php
		...
		$sql="INSERT INTO Utenti VALUES (1,'TTLSNT80D01D810O','Sante','Attalle','3497654234','attallesante@gmail.com',MD5('aaaaaA1!a'),'C'),(2,'NPCRSO72E43E472R','Rosa','Napucci','3279864356','rosanapucci@libero.it',MD5('bbbbbB2?b'),'C'),(3,'CNTTTR02L09E472F','Ettore','Cantile','3451772123','ettore.cantile@css.it',MD5('EttoreC9!'),'D'),(4,'CHRLRD02E28E472W','Leonardo','Chiarparin','3337279141','leonardo.chiarparin@css.it',MD5('LeonarC6?'),'D')";
		mysqli_query($conn,$sql);
		...
		$sql="INSERT INTO Prenotazioni VALUES (1,'2024-04-30',65.00,'N',2,10,12);";
		mysqli_query($conn,$sql);
