...
<?php
	...
	if(isset($_POST["confirm"])){
		...
		$passmd5=md5($password); // CRITTOGRAFIA DELLA password MEDIANTE L'APPLICAZIONE DELL'ALGORITMO MD5 (REGISTRAZIONE NON IN CHIARO => STRINGA DI 32 CIFRE ESADECIMALI (128 bit))
		
		// CONTROLLO PER PERMETTERE LA PROFILAZIONE (INDIVIDUAZIONE DELL'ID, UTILE PER LE FUTURE OPERAZIONI, E IL TIPO DI UTENTE IN MODO TALE DA REINDIRIZZARLO CORRETTAMENTE)
		$sql="SELECT ID, Tipo_Utente FROM Utenti WHERE Email='$email' AND Password='$passmd5'";
