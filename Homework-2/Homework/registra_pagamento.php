...
<?php
	...
	if(isset($_GET["confirm"])){
		if(isset($_GET["prenotazione"])){
			...
			$sql="UPDATE Prenotazioni SET Pagamento='Y' WHERE ID=".$_GET["prenotazione"];
